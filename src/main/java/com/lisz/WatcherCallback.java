...
public class WatcherCallback implements AsyncCallback.StringCallback, AsyncCallback.Children2Callback, AsyncCallback.StatCallback, Watcher {
    ...
    public void tryLock() {
        zk.create("/lock5", threadName.getBytes(), ZooDefs.Ids.OPEN_ACL_UNSAFE, CreateMode.EPHEMERAL_SEQUENTIAL, this, "ctx");
        try {
            latch.await();
    ...
    public void processResult(int rc, String path, Object ctx, String name) {
        if (name != null) { //创建成功，getChildren 盯住前一个，第一个获得锁
            pathName = name;
    ...
    public void processResult(int rc, String path, Object ctx, List<String> children, Stat stat) {
        System.out.println(threadName + " looking lock...");
